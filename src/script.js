...
Promise.all([
  loadPart('app_header', '/src/features/header/header.html'),
  loadPart('app_hero', '/src/features/hero/hero.html'),
  loadPart('app_services', '/src/features/services/services.html'),
  loadPart('app_about', '/src/features/about/about.html'),
  loadPart('app_gallery', '/src/features/gallery/gallery.html'),
  loadPart('app_location', '/src/features/location/location.html'),
  loadPart('app_footer', '/src/features/footer/footer.html'),
]).then(() => {
  ...
  galleryScript.src = '/src/features/gallery/gallery.js';
  document.body.appendChild(galleryScript);

  const servicesScript = document.createElement('script');
  servicesScript.src = '/src/features/services/services.js';
